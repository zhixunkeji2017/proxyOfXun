 ...
 */
public class LogOut {
    private static String secret = "0f5c79113f2f43fbae61s382daac8297";
    private static String timestamp = String.valueOf(System.currentTimeMillis()).substring(0, 10);
    private static String url = "http://api.xdaili.cn/xdaili-api/spider/logOut";
    private static String spiderId = "8ea1baef1c304sed83182b4a0d7ba5c9";
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, UnsupportedEncodingException {
        ...
        // 批量退出的proxyId为key,订单号为value,转换成json格式
        JSONObject jasonObject = JSONObject.parseObject("{\"56909da9b79811e6802371d9ec16a600\":\"FREE0000000000007\"}");
        // key为“map”的value是json类型
        map.put("map", jasonObject);
        HttpPost post = new HttpPost(url);
        String token = LogOut.getToken(timestamp, map);
